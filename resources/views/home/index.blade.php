...
@section('body')
    ...
    <section class="py-5">
        <div class="container">
            <div class="row mb-3">
                <p class="display-3 fw-bold text-center text-decoration-underline pb-3" style="font-family: cursive">Products</p>
            ...
            <div class="row">
                <p class="display-3 fw-bold text-center text-decoration-underline pb-3" style="font-family: cursive">Categories</p>
                @foreach($categories as $category)
                    <div class="col-md-4 mb-3">
                        <div class="card card-body bg-dark text-white h-100">
                            ...
                            <a href="{{ route('product.details',['id'=>$category->id]) }}" class="btn btn-primary btn-sm">view products</a>
                        </div>
                    </div>
                @endforeach
            </div>
            <div class="row">
                <p class="display-3 fw-bold text-center text-decoration-underline pb-3" style="font-family: cursive">Brand's</p>
